...
// APIClient manages communication with the Wallet API v1.0.3
...
type APIClient struct {
	...
	DepositWithdrawApi *DepositWithdrawApiService

	OnboardingApi *OnboardingApiService

	WalletServicesApi *WalletServicesApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.DepositWithdrawApi = (*DepositWithdrawApiService)(&c.common)
	c.OnboardingApi = (*OnboardingApiService)(&c.common)
	c.WalletServicesApi = (*WalletServicesApiService)(&c.common)
